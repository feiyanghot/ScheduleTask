...
namespace SchedulerTask.EloquaExternalActionService {
    ...
    public partial class Member : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private SchedulerTask.EloquaExternalActionService.EntityType EntityTypeField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private int IdField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private SchedulerTask.EloquaExternalActionService.ExternalActionStatus StatusField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public SchedulerTask.EloquaExternalActionService.EntityType EntityType {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public SchedulerTask.EloquaExternalActionService.ExternalActionStatus Status {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://secure.eloqua.com/API/1.2", ConfigurationName="EloquaExternalActionService.ExternalActionService")]
    public interface ExternalActionService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="https://secure.eloqua.com/API/1.2/ExternalActionService/ListExternalActionStepsBy" +
            ...
            "TypeResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(SchedulerTask.EloquaExternalActionService.UnexpectedErrorFault), Action="https://secure.eloqua.com/API/1.2/ExternalActionService/ListExternalActionStepsBy" +
            "TypeUnexpectedErrorFaultFault", Name="UnexpectedErrorFault")]
        SchedulerTask.EloquaExternalActionService.Step[] ListExternalActionStepsByType(string externalProvider);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="https://secure.eloqua.com/API/1.2/ExternalActionService/GetMemberCountInStepBySta" +
            ...
            "tusResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(SchedulerTask.EloquaExternalActionService.UnexpectedErrorFault), Action="https://secure.eloqua.com/API/1.2/ExternalActionService/GetMemberCountInStepBySta" +
            "tusUnexpectedErrorFaultFault", Name="UnexpectedErrorFault")]
        int GetMemberCountInStepByStatus(int stepId, SchedulerTask.EloquaExternalActionService.ExternalActionStatus status);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="https://secure.eloqua.com/API/1.2/ExternalActionService/ListMembersInStepByStatus" +
            ...
            "Response")]
        [System.ServiceModel.FaultContractAttribute(typeof(SchedulerTask.EloquaExternalActionService.UnexpectedErrorFault), Action="https://secure.eloqua.com/API/1.2/ExternalActionService/ListMembersInStepByStatus" +
            "UnexpectedErrorFaultFault", Name="UnexpectedErrorFault")]
        SchedulerTask.EloquaExternalActionService.Member[] ListMembersInStepByStatus(int stepId, SchedulerTask.EloquaExternalActionService.ExternalActionStatus status, int pageNumber, int pageSize);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(SchedulerTask.EloquaExternalActionService.UnexpectedErrorFault), Action="https://secure.eloqua.com/API/1.2/ExternalActionService/SetMemberStatusUnexpected" +
            "ErrorFaultFault", Name="UnexpectedErrorFault")]
        SchedulerTask.EloquaExternalActionService.Member[] SetMemberStatus(SchedulerTask.EloquaExternalActionService.Member[] members, SchedulerTask.EloquaExternalActionService.ExternalActionStatus status);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ExternalActionServiceChannel : SchedulerTask.EloquaExternalActionService.ExternalActionService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ExternalActionServiceClient : System.ServiceModel.ClientBase<SchedulerTask.EloquaExternalActionService.ExternalActionService>, SchedulerTask.EloquaExternalActionService.ExternalActionService {
        ...
        public SchedulerTask.EloquaExternalActionService.Step[] ListExternalActionStepsByType(string externalProvider) {
            return base.Channel.ListExternalActionStepsByType(externalProvider);
        }
        
        public int GetMemberCountInStepByStatus(int stepId, SchedulerTask.EloquaExternalActionService.ExternalActionStatus status) {
            return base.Channel.GetMemberCountInStepByStatus(stepId, status);
        }
        
        public SchedulerTask.EloquaExternalActionService.Member[] ListMembersInStepByStatus(int stepId, SchedulerTask.EloquaExternalActionService.ExternalActionStatus status, int pageNumber, int pageSize) {
            return base.Channel.ListMembersInStepByStatus(stepId, status, pageNumber, pageSize);
        }
        
        public SchedulerTask.EloquaExternalActionService.Member[] SetMemberStatus(SchedulerTask.EloquaExternalActionService.Member[] members, SchedulerTask.EloquaExternalActionService.ExternalActionStatus status) {
